...
{	
	...
	private JMenuItem optQuitter = new JMenuItem("Quitter");
	/* menu Dessin */
	...
	{	
		...
		optQuitter.addActionListener(new ActionListener(){
		...
		optQuitter.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q, KeyEvent.CTRL_DOWN_MASK));
		
		/* Ajout des sous-categories aux categories de la barre de menu */
		this.menuFichier.add(optQuitter);
